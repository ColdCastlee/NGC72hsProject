...
public class BossBehaviors : MonoBehaviour
{
    ...
    public float ShootVelocity = 1.5f;
    public int BulletDamage = 1;
    private float _shootClock = 0.5f;
    //圆圈射击
    ...
    private void BasicAtk()
    {
        ...
        {
            //TODO::PARENT
            var bulletScript = Instantiate(Bullet, transform.position, Quaternion.identity)
                .GetComponent<NormalBullet>();
            bulletScript.Init(BulletDamage, _targetDir, ShootVelocity);
        }
    }
}